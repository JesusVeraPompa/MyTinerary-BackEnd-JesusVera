...
const cities = [
    {
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/0/03/Flag_of_Moscow%2C_Russia.svg",
    },
    {
        id: 2,
        ...
        flag_country:'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Flag_of_Russia.svg/1280px-Flag_of_Russia.svg.png',
        continent: 'Europe and Asia',
        description: 'Saint Petersburg is a Russian city located at the mouth of the Neva River in the Gulf of Finland. With approximately 5,383,890 inhabitants, it is the second most populous and important city in the country, only surpassed by the capital, Moscow. It is also known as the "Venice of the North" due to its numerous canals. It is considered one of the most beautiful capitals in Europe, and one of the cultural capitals of Europe and the world (opera, ballet, music, museums, Imperial Academy of Arts, among others).',
        population: 5383890,
        language:"Russian",
        currency: 'Ruble',
        img_currency:"https://cronicanumismatica.com/wp-content/uploads/2021/05/100r_97_rv-1140x512.jpg",
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/c/ca/Flag_of_Saint_Petersburg.svg",
    },
    {
        id: 3,
        name: 'Shanghai',
    ...
    },
    {
        ...
        flag_country:'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fa/Flag_of_the_People%27s_Republic_of_China.svg/1280px-Flag_of_the_People%27s_Republic_of_China.svg.png',
        continent: 'Asia',
        description: 'Beijing is the capital of the People´s Republic of China and one of the most populous cities in the world with 21,890,000 inhabitants in 2020. It is also, along with Shanghai, Tianjin and Chongqing, one of the four municipalities of the country.',
        population: 21893095,
        language:"Mandarin Chinese",
        currency: 'Yuan',
        img_currency:"https://www.thechinaguide.com/uploads/edt/2/671c3ef2a0-100rmb.jpg",
    ...
    },
    {
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/b/ba/Flag_of_New_York_City.svg",
    },
    {
        id: 6,
        name: 'Los Angeles',
        ...
        flag_country:'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Flag_of_the_United_States.svg/800px-Flag_of_the_United_States.svg.png',
        continent: 'North America',
        description: 'Los Angeles, officially the City of Los Angeles (in English: City of Los Angeles) and abbreviated LA, or L.A., is the most populous city in the state of California and the second most populous city in the United States, after New York City. It has, according to the 2020 Census, a population of approximately 3,983,540 inhabitants, experiencing a growth of 4.9% in ten years. It is located in Southern California and covers an area of ​​1,215 km². The city is the center of the Los Angeles-Long Beach-Santa Ana Metropolitan Statistical Area and Greater Los Angeles, which according to the 2010 census had a population of thirteen and eighteen million people, respectively. It is therefore one of the largest metropolitan areas in the world and the second in the United States. The city is also the seat of Los Angeles County, one of the most populous and ethnically diverse counties in the country.',
        population: 3983540,
        language:"American English",
        currency: 'Dollar',
        img_currency:"https://www.shutterstock.com/image-vector/vector-obverse-high-poly-pixel-600nw-2447906059.jpg",
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/85/Flag_of_Los_Angeles%2C_California.svg/800px-Flag_of_Los_Angeles%2C_California.svg.png",
    },
    {
        id: 7,
        name: 'Paris',
        ...
        country: 'France',
        flag_country:'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Flag_of_France_%281794%E2%80%931815%2C_1830%E2%80%931974%2C_2020%E2%80%93present%29.svg/1280px-Flag_of_France_%281794%E2%80%931815%2C_1830%E2%80%931974%2C_2020%E2%80%93present%29.svg.png',
        continent: 'Europe',
        description: 'Paris is the capital and most populous city of France. Capital of the Île-de-France region, it is the only unicommunal department in the country. Its metropolitan area is the most populated in the entire European Union. Established in the centre of the Paris basin, in a loop of the Seine River, between the confluences with the Marne and the Oise. It was occupied from the 3rd century BC by the Gallic people of the Parisii, on the original site of Lutetia, from which it took the name of Paris around the year 310, to spread out in its surrounding area. Capital of the kingdom of the Franks during the reign of Clovis I, Paris became one of the main cities of France during the 10th century, with royal palaces, rich abbeys and a cathedral.',
        population: 8804109,
        language:"French",
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/Flag_of_Paris_with_coat_of_arms.svg/800px-Flag_of_Paris_with_coat_of_arms.svg.png",
    },
    {
        id: 8,
        name: 'Marseilles',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Flag_of_Marseille.svg/800px-Flag_of_Marseille.svg.png",
    },
    {
        id: 9,
        name: 'Tokyo',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Flag_of_Tokyo_Metropolis.svg/800px-Flag_of_Tokyo_Metropolis.svg.png",
    },
    {
        id: 10,
        name: 'Yokohama',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Flag_of_Yokohama%2C_Kanagawa.svg/600px-Flag_of_Yokohama%2C_Kanagawa.svg.png",
    },
    {
        id: 11,
        name: 'Toronto',
        ...
        country: 'Canada',
        flag_country:'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d9/Flag_of_Canada_%28Pantone%29.svg/800px-Flag_of_Canada_%28Pantone%29.svg.png',
        continent: 'North America',
        description: 'Toronto is the capital of the province of Ontario and, with a population of 2,794,356, is the largest and most populous city in Canada, as well as the country`s financial centre. Its metropolitan area has a total population of over 6,202,225. Located on the northwest shore of Lake Ontario, it is the fifth-largest city in North America. Toronto is located at the heart of the Greater Toronto Area (GTA), the largest metropolitan area in Canada, and is part of a densely populated region in south-central Ontario known as the Golden Horseshoe, home to eight million people.',
        population: 2794356,
        language:"English and French",
        currency: 'Canadian dollar',
        img_currency:"https://www.shutterstock.com/image-photo/robert-borden-portrait-canada-100-600nw-1614911866.jpg",
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Flag_of_Toronto%2C_Canada.svg/800px-Flag_of_Toronto%2C_Canada.svg.png",
    },
    {
        id: 12,
        name: 'Montreal',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Flag_of_Montreal.svg/435px-Flag_of_Montreal.svg.png",
    },
    {
        id: 13,
        name: 'Bogota',
        ...
        country: 'Colombia',
        flag_country:'https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Flag_of_Colombia.svg/800px-Flag_of_Colombia.svg.png',
        continent: 'South America',
        description: 'Bogotá is the capital of the Republic of Colombia and of the department of Cundinamarca. It is administered as a capital district, and enjoys autonomy for the management of its interests within the limits of the Constitution and the law. Unlike the other districts of Colombia, Bogotá is a territorial entity of the first order, with the administrative powers that the law confers on the departments. It is made up of 20 localities, where each of these has its own mayor, who is called Minor Mayor, and a Local Administrative Board (JAL), and is the political, economic, administrative, industrial, artistic, cultural, sports and tourist epicenter of the country.',
        population: 8034649,
        language:"Spanish",
        currency: 'Colombian Peso',
        img_currency:"https://icambio.es/wp-content/uploads/2020/04/billete-de-5000-pesos-colombianos-anverso.png",
        time_zone: 'Pacific Standard Time, South America (UTC-05:00) Bogota, Lima, Quito, Rio Branco',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Flag_of_Bogot%C3%A1.svg/750px-Flag_of_Bogot%C3%A1.svg.png",
    },
    {
        id: 14,
        name: 'Medellin',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Flag_of_Medell%C3%ADn.svg/763px-Flag_of_Medell%C3%ADn.svg.png",
    },
    {
        id: 15,
        name: 'Reykjavík',
        ...
        flag_cities:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/Flag_of_Reykjavik%2C_Iceland.svg/393px-Flag_of_Reykjavik%2C_Iceland.svg.png",
    },
    {
        id: 16,
        name: 'Kopavogur',
