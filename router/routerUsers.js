...
import { allUser, userByID, userByName, userExists } from '../controllers/users/readUser.js'
...
routerUsers.get('/validateToken', passport.authenticate('jwt', { session: false }), userExists)
